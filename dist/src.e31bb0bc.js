...
/*export function css(styles = {}) {
    /!*    //Итерация по объекту
        const keys = Object.keys(styles); //массив ключей объекта
...
var TextBlock = /*#__PURE__*/function (_Block2) {
  ...
  _createClass(TextBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var test = (0, _utils.css)(this.options.styles);
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      var _this$options2 = this.options,
          ...
          alt = _this$options2$alt === void 0 ? 'Картинка' : _this$options2$alt,
          is = _this$options2.imageStyle;
      return (0, _utils.row)("<img alt=\"".concat(alt, "\" src=\"").concat(this.value, "\" style=\"").concat((0, _utils.css)(is), "\"/>"), (0, _utils.css)(styles));
    }
  }]);
...
var _image = _interopRequireDefault(require("../src/assets/image.png"));
...
exports.model = model;
},{"../src/assets/image.png":"assets/image.png","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      var updateCallback = function updateCallback(newBlock) {
        //определяем функ-ю, которая следит за обновлением
